...
import dogSketch from '@/sketch-to-image-images/dog-sketch.png';
import generatedImageWeak from '@/sketch-to-image-images/dog-low.png';
import generatedImageStrong from '@/sketch-to-image-images/dog-high.png';

const STIBox6: React.FC = () => {
        ...
        <div className="flex flex-col items-center justify-center mt-8 mb-8 w-full max-w-4xl">
            <div className="border-4 border-black bg-white p-4 rounded-lg shadow-lg w-full h-auto overflow-hidden">
                <div className="border-b pb-2 mb-4 flex justify-between items-center">
                    <h2 className="text-2xl font-bold m-2 text-center">Here is another example!</h2>
                </div>
                <div className="flex flex-col md:flex-row justify-between items-start">
                    <div className="flex flex-col space-y-4 mb-4 md:mb-0">
                        <div>
                            <div className="font-bold mb-4">Landscape Sketch</div>
                            <Image src={dogSketch} alt="Car Sketch" className="rounded-lg border-4 border-black" width={300} height={300} />
                        </div>
                    </div>
