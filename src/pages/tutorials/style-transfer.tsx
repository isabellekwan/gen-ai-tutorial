...
import STTutorialChat from '@/components/tutorial/ST/STTutorialChat';
            ...
            <section className="flex flex-col lg:flex-row items-start pt-32">
                <div className="w-full flex flex-col lg:flex-row lg:items-center">
                    <div className="w-full lg:w-3/4">
                        <h1 className="text-6xl lg:text-8xl font-bold mt-8 mb-8 animate__animated animate__fadeInLeft">Style Transfer Tutorial</h1>
                        <p className="max-w-3xl text-left mb-4 text-2xl lg:text-2xl animate__animated animate__pulse">
                            Welcome to our Style Transfer Tutorial, where you will learn how to transform one image into 
                            another by applying artistic styles.
                        </p>
